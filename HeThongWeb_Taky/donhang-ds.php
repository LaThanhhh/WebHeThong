                            ...
                            <div class="column column-12">
                                ...
                                <div class="section_content">
                                    <div class="poListContainer">
                                        <?php
                                           // $stmt = $conn->prepare("
                                            //SELECT * FROM donhang, id, tenkhachhang
                                         ...
                                         //       ");
                                           // $stmt->execute();
                                            ...
                                            //var_dump($row);
                                            //$data = [];
                                            //foreach($danhsach_donhangs as $danhsach_donhang){
                                                //$data[$danhsach_donhang['']][] = $danhsach_donhang;
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    <?php foreach($users as $index => $user){ ?>
                                                        ...
                                                        <tr>
                                                            <td><?= $index + 1 ?></td>
                                                            <td class="tenkhachhang"><?= $user['tenkhachhang'] ?></td>
                                                            <td class="email"><?= $user['email'] ?></td>
                                                            <td class="tongtien"><?$user['tongtien']?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="" class="deleteUser" data-userid="<?= $user['id'] ?>" data-fname="<?= $user['tenkhachhang'] ?>"><i class="fa fa-trash"></i>Xóa</a>
                                                            </td>
                                                        </tr>
                                                <?php } ?>
                                                </tbody>
